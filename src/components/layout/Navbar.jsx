    ...
    <header className="sticky top-0 z-50 border-b border-slate-200/80 bg-white/90 backdrop-blur-xl">
      ...
      >
        ...
        <button
          ...
          className="rounded-lg p-2 text-2xl text-slate-800 hover:bg-slate-100 md:hidden"
        >
          {isOpen ? <FiX /> : <FiMenu />}
        </button>
      </nav>
            ...
            <div className="mx-auto flex max-w-7xl flex-col px-5 py-5">
              ...
              <div className="mt-3 flex gap-3">
                <Link
                  to="/faq"
                  onClick={() => setIsOpen(false)}
                  className="flex-1 rounded-xl border border-slate-200 px-4 py-3 text-center font-bold text-slate-700 hover:bg-slate-50"
                >
                  FAQ
                </Link>
