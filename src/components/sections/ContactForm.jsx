            ...
            <div className="mx-auto grid max-w-7xl gap-12 px-5 lg:grid-cols-[.7fr_1.3fr] lg:px-6">
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="rounded-3xl border border-slate-200 bg-white p-6 shadow-xl shadow-slate-900/5 md:p-8">
                    ...
                    <div className="grid gap-5 md:grid-cols-2">
                        ...
                        <label className="text-sm font-semibold text-slate-700">Estimated budget<select {...register("budget")} className={`${inputClass} mt-2`}><option>Not sure yet</option><option>Under SLE1000</option><option>SLE1000 – SLE1500</option><option>SLE1500 – SLE5000</option><option>SLE5000+</option></select></label>
