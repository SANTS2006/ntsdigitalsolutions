...
function ContactForm() {
    ...
    async function onSubmit(data) {
        ...
        try {
            ...
            setStatus({
                type: "success",
                text: "Thanks — your project brief has been sent. We will get back to you soon.",
            });
            ...
            <div className="mx-auto grid max-w-7xl gap-12 px-5 lg:grid-cols-[.7fr_1.3fr] lg:px-6">
                ...
                <div>
                    ...
                    <p className="mt-5 leading-7 text-slate-600">
                        A few details help us understand your goals before
                        the first conversation. You don't need a finished
                        specification — a clear problem is enough to get started.
                    </p>
                ...
                >
                    ...
                    <div className="mt-6 flex flex-wrap items-center justify-between gap-4">
                        ...
                        <p className="max-w-md text-xs leading-5 text-slate-500">
                            By submitting this form, you are simply starting
                            a project conversation. No commitment is required.
                        </p>
