  ...
  <section className="bg-slate-50 py-24">
    <div className="mx-auto max-w-7xl px-5 lg:px-6">
      <div className="grid gap-6 lg:grid-cols-2">
        <article className="relative overflow-hidden rounded-3xl bg-slate-950 p-8 text-white md:p-10">
          <FiFlag className="text-3xl text-blue-300" />
          <p className="mt-8 text-xs font-bold uppercase tracking-[.22em] text-blue-300">Our mission</p>
